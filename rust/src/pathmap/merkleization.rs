...
use super::xxhash_fallback as xxhash;
use super::trie_core::node::{NODE_ITER_FINISHED, TrieNodeODRc};
...
pub(crate) fn merkleize_impl<V, A>(
    ...
    memo: &mut xxhash::HashMap<u128, TrieNodeODRc<V, A>>,
    ...
    A: Allocator,
{
    ...
    let mut hasher = xxhash::XxHasher::with_seed(INITIAL_SEED as u64);
...
mod tests {
    ...
    fn test_btm_merkleize() {
        ...
        #[cfg(feature = "viz")]
        {
            ...
            use super::viz::{DrawConfig, viz_maps};
