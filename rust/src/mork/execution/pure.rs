...
// EVAL FFI FUNCTIONS GATED - requires eval_ffi crate
// macro_rules! op {
...
//     if items != 1 { return Err(EvalError::from("only takes one argument")) }
//     let e: super::expr::Expr = expr.consume()?;
//     let h = e.hash();
...
//     let t: super::expr::Expr = expr.consume()?;
//     if is_nz {
...
//             let f: super::expr::Expr = expr.consume()?;
