...
/// Create a new PeTTaEngine instance with verbose output enabled.
#[allow(dead_code)]
pub fn make_verbose_engine() -> PeTTaEngine {
    PeTTaEngine::new(&project_root(), true).expect("Failed to create engine")
}
